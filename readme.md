...
![Neural Network API](img/nnapi.png){width=350px}
![Firebase ML Kit](img/fbmlkit.png){width=350px}
...
![iOS app transitions](img/transitions.png){width=380px}

![iOS app launch cycle](img/cycle.png){width=350px}
...
**Capabilities**: Example: location detection, orientation, audio, proximity, ecc... Reinvent ways to meet people's needs!!! For example, augumented reality to navigate space around you.
